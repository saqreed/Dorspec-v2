...
const projects = [
  {
    ...
    description: 'Прокладка всех инженерных коммуникаций',
    image: 'https://images.unsplash.com/photo-1564013799919-ab600027ffc6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1000&q=80',
  },
  {
    title: 'Бизнес-центр "Столичный"',
    description: 'Монтаж систем электроснабжения и телекоммуникаций',
  ...
  },
  {
    ...
    description: 'Комплексная прокладка коммуникаций',
